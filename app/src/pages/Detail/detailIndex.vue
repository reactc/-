          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(supSaleAttr) in supSaleAttrList" :key="supSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: supSaleAttValue.isChecked == 1 }"
                  v-for="(supSaleAttValue) in supSaleAttr.spuSaleAttrValueList" :key="supSaleAttValue.id"
                  @click="changeActive(supSaleAttValue, supSaleAttr.spuSaleAttrValueList)">
                  {{
                      supSaleAttValue.saleAttrValueName
                  }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
...
export default {
  ...
  computed: {
    ...mapGetters(['categoryView', 'skuInfo', 'supSaleAttrList']),
    //给子组件仍数据
    skuImageList() {
