    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont"
                      :class="{ 'icon-xiangshang': isAsc, 'icon-paixu': isDesc }"></span></a>
                </li>
          ...
          <!-- 分页器 -->
          <paginationIndex :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5"
...
export default {
  ...
  methods: {
    ...
    //删除关键字
    removeKeyword() {
      //给服务器到的参数searchparams的keyword置空
